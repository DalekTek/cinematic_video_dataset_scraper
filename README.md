...
Проект построен на основе SOLID принципов:

- **Single Responsibility**: Каждый класс отвечает за одну функцию
- **Open/Closed**: Легко расширяется новыми источниками видео
- **Liskov Substitution**: Интерфейсы позволяют заменять реализации
- **Interface Segregation**: Разделенные интерфейсы для разных функций
